...
**ANSWER:** No, discuss statistics. Refer to lecture notes.
...
calibration.plot(valData, which.model=1, N.bins=20, xlab='predicted', ylab='Observed', main='glmBack')
calibration.plot(valData, which.model=2, N.bins=20, xlab='predicted', ylab='Observed', main='glmAbs')
```
