...
# rfMap2 = predict(covariates, rfModel2, type='prob', index=2)
# 
# valData = data.frame('ID' = 1:nrow(valPres)) %>%
#   mutate(obs = valPres$INBU,
...
# 
#   
# boyceVals[i] = ecospat.boyce(fit = rfMap2, obs=valData[,3], res=100, PEplot=F)$cor
# 
# }
# 
# rfBV <- mean(boyceVals)
...
#   valData = data.frame('ID' = 1:nrow(valPres)) %>% 
#   mutate(obs = valPres$INBU,
#          maxentVal = predict(maxentModel2, valPres %>% dplyr::select(elevation:treecover), type='response'))
#   
