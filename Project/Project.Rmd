...
# **Fit GAM Using The Same Covariates & Plot Predicted Presence**
```{r, warning=F, error=F, message=F}
...
# **Fit Boosted Regresssion Tree Using The Same Covariates & Plot Predicted Presence**
```{r, warning=F, error=F, message=F}
set.seed(2024)
...
# **Fit Random Forest Model Using The Same Covariates & Plot Predicted Presence**
```{r, warning=F, error=F, message=F}
set.seed(2024)
