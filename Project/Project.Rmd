...
```{r}
# Assuming aucValues and kappaValues matrices have been correctly filled as per your loops
...
# Assuming the resultsTable is already created with the mean AUC and Kappa values
resultsTable <- data.frame(
  Model = c("GLM", "GAM", "Boosted Regression", "Random Forest"),
  Mean_AUC = meanAucValues,
  Mean_Kappa = meanKappaValues
...
# Plotting with reference lines for interpretation
