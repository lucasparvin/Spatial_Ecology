...
###########################################################
# library(caret)  # for kfold
# library(ROCR)   # for AUC calculation
# library(pROC)   # for alternative AUC, if desired
# library(presenceAbsence)  # for sensitivity, specificity, and kappa

# Assuming presCovs and backCovs are already prepared and contain the required predictor and response columns
set.seed(2024)
