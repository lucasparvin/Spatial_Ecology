...
## THESE ARE INCORRECT. HERE I HAVE JUST SEPARATED presence data and covariates from absence data and covariates ##
...
presPoints$kfold = kfold(presPoints, k=5)
absPoints$kfold = kfold(absPoints, k=5)
...
for(i in 1:5){
  ...
  # valPresOnly = training[which(training$INBU==1),]
  ...
  #In here, you can add in the other models
