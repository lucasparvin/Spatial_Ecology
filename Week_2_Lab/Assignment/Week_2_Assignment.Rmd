...
```{r}
# URL of the zipped shapefile on GitHub (modified for direct download)
url <- "https://raw.githubusercontent.com/lucasparvin/Spatial_Ecology/main/Week_2_Lab/Assignment/AL_WMA.zip"

# Download the file
download.file(url, destfile = "AL_WMA.zip", mode = "wb")

# Unzip the file
unzip("AL_WMA.zip", exdir = "AL_WMA")

# List files in the unzipped directory to find the name of the .shp file
list.files("AL_WMA")

# Load the library
library(terra)

# Load the shapefile (replace 'your_shapefile_name.shp' with the actual name)
wma_shapefile <- vect("AL_WMA/AL_WMA/AL_wma.shp")
