...
# Load the shapefile
# Replace with the actual path to the unzipped shapefile
...
legend("right", legend = landcover_labels, fill = landcover_colors, cex = 0.7, bg = 'white')

# Use par(xpd=TRUE) and specify coordinates for legend
par(xpd = TRUE)
legend(x = 1.1, y = 1, legend = landcover_labels, fill = landcover_colors, cex = 0.7, bg = 'white', horiz = FALSE, xjust = 0)
